    ...
    <div className="bg-white min-h-screen text-gray-800 p-8 md:p-12 font-sans max-w-4xl mx-auto page-fade-in print:p-0">
      ...
      <div className="space-y-12">
        ...
        <ScriptSection 
          ...
          show="/faculty/parent-visit then click through to /parent"
...
function ScriptSection({ step, time, title, show, say, click }: ScriptSectionProps) {
  return (
