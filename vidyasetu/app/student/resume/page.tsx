...
import { Download, Edit2, CheckCircle2, GripVertical, AlertTriangle, Send, Link as LinkIcon } from 'lucide-react'
...
export default function ResumeBuilderPage() {
  ...
  return (
    <div className="bg-gray-50/50 min-h-full pb-20 relative">
      ...
      {reviewModalOpen && (
        <Modal onClose={() => setReviewModalOpen(false)} title="Request Faculty Review" width="sm">
