...
import { Users, Sparkles, CheckCircle, AlertTriangle, Target, Check } from 'lucide-react'
...
export default function CareerPathPage() {
  ...
  const [activeTab, setActiveTab] = useState<keyof typeof trajectories>('A')
  ...
  return (
    <div className="bg-gray-50/50 min-h-full">
      <div className="max-w-7xl mx-auto p-6 md:p-8 space-y-10 animate-fade-in pb-10">
            ...
            <div>
              ...
              <div className="bg-purple-50/80 border border-purple-100 rounded-2xl p-5 flex gap-4 shadow-sm relative overflow-hidden">
                ...
                <p className="text-purple-900 text-sm font-bold leading-relaxed">
                  Based on {displayName}&apos;s complete profile — 7-dimension skill analysis, 3 completed projects, 4 hackathon participations, and 4 semesters of academic data — the AI Career Advisor has generated the following recommendations with high confidence.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex bg-gray-100 p-1 rounded-xl w-fit mb-6 overflow-x-auto max-w-full hide-scrollbar">
                {Object.entries(trajectories).map(([key, data]) => (
                  <button
                    key={key}
                    onClick={() => setActiveTab(key as keyof typeof trajectories)}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-3 bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
                  <div className="relative pl-8 space-y-8 before:absolute before:inset-0 before:ml-[11px] before:w-0.5 before:bg-gray-100 before:z-0 py-2">
                    {currentPath.timeline.map((step: any, i: number) => (
            ...
            <div>
              ...
              <div className="bg-teal-50 border border-teal-100 rounded-xl p-4 flex gap-4 mb-6 shadow-sm">
                ...
                <p className="text-teal-900 text-sm font-medium leading-relaxed">
                  These alumni had similar SPI scores, skill profiles, project types and extracurricular patterns to your current profile when they were in 2nd year. Their outcomes are the most realistic preview of your possible future.
                </p>
              </div>
                  ...
                  <div key={i} className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex flex-col">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="flex flex-col items-end gap-1.5">
                        ...
                        {alumni.connected && <span className="px-2 py-0.5 bg-green-50 text-green-700 font-bold text-[10px] rounded-full flex items-center gap-1"><CheckCircle size={10} /> Connected</span>}
                      </div>
                    </div>
