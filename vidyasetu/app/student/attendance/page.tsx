...
export default function AttendanceView() {
  const [activeCalSubject, setActiveCalSubject] = useState<keyof typeof calendarData>('TOC')
  ...
  const renderCalCell = (dayNum: number) => {
              ...
              <div className="p-8 border-b border-gray-50 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex items-center gap-2 p-1 bg-gray-50 rounded-xl border border-gray-200">
                  {['DBMS', 'OS', 'TOC', 'DSA'].map((s) => (
                    <button
                      key={s}
                      onClick={() => setActiveCalSubject(s as keyof typeof calendarData)}
