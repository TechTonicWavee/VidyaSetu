 ...
 * @param {Array}  params.internships - Array of internship records
 * @param {string} [params.studentName] - Student name for recipient identity matching
 * @param {number} [params.admissionYear] - Student admission calendar year
 * @returns {Promise<Object>} score, semester, targets, breakdown, metadata
 */
