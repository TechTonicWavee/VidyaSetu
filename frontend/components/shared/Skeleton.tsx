...
/** Generic shimmer block. Use for bespoke loading layouts. */
export function Skeleton({ className = '' }: { className?: string }) {
  return <div className={`relative overflow-hidden rounded-lg bg-surface-3 ${className}`}><div className="absolute inset-0 animate-shimmer" /></div>
}
