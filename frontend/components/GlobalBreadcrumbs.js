...
export function GlobalBreadcrumbs() {
  ...
  const generateBreadcrumbs = () => {
    ...
    let basePath = ''
    let roleName = ''
    if (segments.includes('student')) { basePath = '/student'; roleName = 'Student Dashboard' }
    else if (segments.includes('faculty')) { basePath = '/faculty'; roleName = 'Faculty Dashboard' }
    else if (segments.includes('dean')) { basePath = '/dean'; roleName = 'Dean Dashboard' }
    else if (segments.includes('admin')) { basePath = '/admin'; roleName = 'Admin Dashboard' }
    else if (segments.includes('parent')) { basePath = '/parent'; roleName = 'Parent Dashboard' }
    else { basePath = '/'; roleName = 'Home' }
