...
const navLinks = [
  { id: 'dashboard',    label: 'Dashboard',            icon: Home,       badge: null, active: false, path: '/dean' },
  ...
  { id: 'cross',        label: 'Year-wise Insights',   icon: Target,     badge: null, active: true,  path: '/dean/cross-branch' },
