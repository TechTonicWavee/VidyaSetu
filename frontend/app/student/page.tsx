          ...
          <Card className="h-full flex flex-col p-6 shadow-sm border-line/60 hover:shadow-md transition-shadow">
            ...
            <div className="flex-1 min-h-[160px] -ml-2">
              {spiLoading ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center min-h-[160px] text-muted opacity-60">
                  <Activity className="w-8 h-8 mb-2" />
                  <span className="text-sm font-medium">No SPI data available yet</span>
                </div>
              ) : (
                <SpiProgressionChart data={spiHistory} />
              )}
            </div>
          </Card>
        </div>
