...
export default function FacultyParentCommunication() {
  ...
  const [activeNav] = useState('parents')
              ...
              <div className="w-full lg:w-[35%] flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto">
                  ...
                  <div className="p-4 border-b border-gray-100 bg-blue-50 cursor-pointer relative">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Arman Singh · 2CS04</p>
                  ...
                  <div className="p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Rohit Sharma · 2CS47</p>
                    <div className="flex justify-between items-end gap-4">
                  ...
                  <div className="p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Sneha Patel · 2CS23</p>
                  ...
                  <div className="p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Karan Joshi · 2CS15</p>
                  ...
                  <div className="p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Arjun Mehta · 2CS09</p>
                    <div className="flex justify-between items-end gap-4">
                  ...
                  <div className="p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Divya Nair · 2CS31</p>
                  ...
                  <div className="p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Ananya Verma · 2CS07</p>
                  ...
                  <div className="p-4 hover:bg-gray-50 cursor-pointer transition">
                    ...
                    <p className="text-xs text-gray-500 mb-2">Krish Singhal · 2CS22</p>
              ...
              <div className="flex-1 flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-5 border-b border-gray-100 flex flex-wrap justify-between items-center gap-4 bg-white z-10 shadow-sm relative">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-medium">Parent of Arman Singh · 2CS04 · CSE 2B</p>
                  </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-gray-50/50 space-y-6">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="max-w-[75%] bg-blue-600 text-white p-4 rounded-2xl rounded-tr-sm shadow-sm">
                      <p className="text-sm leading-relaxed">
                        Dear Mr. Singh, I wanted to inform you that Arman's attendance in Theory of Computation has dropped to 74% — just below the 75% minimum threshold. He needs to attend all remaining classes to maintain eligibility.
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col items-start">
                    <div className="max-w-[75%] bg-white border border-gray-200 text-gray-800 p-4 rounded-2xl rounded-tl-sm shadow-sm">
                      <p className="text-sm leading-relaxed">
                        That would be very helpful. Also, Arman mentioned his DBMS practical went well — we are glad to hear that at least. Please do share the notes.
                      </p>
                    </div>
                    <div className="mt-1 text-[10px] text-gray-400 ml-1">
                      <span>9:45 AM</span>
                ...
                <div className="p-6 border-t border-gray-200">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition bg-white">
                      ...
                      <div className="bg-gray-50 p-3 rounded-lg mb-5 border border-gray-100 text-sm text-gray-700">
                        <span className="font-bold text-navy block mb-1 text-xs uppercase tracking-wider">Agenda:</span>
                        DBMS score decline — 3 consecutive units
                      </div>
                    ...
                    <div className="border border-teal-200 border-2 rounded-xl p-5 shadow-md bg-white">
                      ...
                      <div className="space-y-2 mb-5">
                        ...
                        <div className="flex items-center gap-2 text-sm text-blue-700 font-medium">
                          <Video size={14} className="text-blue-500" /> Online — Google Meet
                        </div>
                      </div>
                      ...
                      <div className="bg-red-50 p-3 rounded-lg mb-5 border border-red-100 text-sm text-gray-700">
                        ...
                        <span className="text-red-900">Critical — attendance and multiple risk factors</span>
                      </div>
